...
#[repr(C)]
pub enum FLT_FILE_NAME_OPTIONS_ENUM {
    FLT_VALID_FILE_NAME_FORMATS = 0x000000ff,
    FLT_FILE_NAME_NORMALIZED = 0x00000001,
    FLT_FILE_NAME_OPENED = 0x00000002,
    FLT_FILE_NAME_SHORT = 0x00000003,
    FLT_VALID_FILE_NAME_QUERY_METHODS = 0x0000ff00,
    FLT_FILE_NAME_QUERY_DEFAULT = 0x00000100,
    FLT_FILE_NAME_QUERY_CACHE_ONLY = 0x00000200,
    FLT_FILE_NAME_QUERY_FILESYSTEM_ONLY = 0x00000300,
    FLT_FILE_NAME_QUERY_ALWAYS_ALLOW_CACHE_LOOKUP = 0x00000400,
    FLT_VALID_FILE_NAME_FLAGS = 0xff000000,
    FLT_FILE_NAME_REQUEST_FROM_CURRENT_PROVIDER = 0x01000000,
    FLT_FILE_NAME_DO_NOT_CACHE = 0x02000000,
    FLT_FILE_NAME_ALLOW_QUERY_ON_REPARSE = 0x04000000,
}
